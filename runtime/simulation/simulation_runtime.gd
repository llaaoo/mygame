...
func _register_default_reactions() -> void:
	...
	wet_ice.entity_status_path = "res://runtime/combat/skills/data/frozen.tres"
	...
	dry_fire.entity_status_path = "res://runtime/combat/skills/data/burning.tres"
	...
	dry_ice.entity_status_path = "res://runtime/combat/skills/data/frozen.tres"
